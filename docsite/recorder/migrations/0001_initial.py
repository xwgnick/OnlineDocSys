# Generated by Django 3.0.6 on 2020-06-18 03:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Herb',
            fields=[
                ('herb_id', models.AutoField(primary_key=True, serialize=False)),
                ('herb_name', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recorder.Patient')),
            ],
            options={
                'db_table': 'record',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.IntegerField(blank=True, null=True)),
                ('herb', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='recorder.Herb')),
            ],
            options={
